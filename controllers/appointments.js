...
//@route    POST /api/vi/hospitals/:hospitalId/appointment
//@access   Private
exports.addAppointment = async (req, res, next) => {
  try {
    ...
    if (!hospital) {
      return res.status(404).json({
        success: false,
        massage: `No hospital with the id of ${req.params.hospitalId}`,
      });
    }
...
exports.updateAppointment = async (req, res, next) => {
  try {
    ...
    if (!appointment) {
      return res.status(404).json({
        success: false,
        massage: `No appointment with the id of ${req.params.id}`,
      });
    }
